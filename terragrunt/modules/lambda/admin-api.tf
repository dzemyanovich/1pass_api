resource "aws_api_gateway_rest_api" "admin_api" {
  ...
  depends_on  = [
    aws_lambda_function.get_bookings_lambda,
    aws_lambda_function.confirm_visit_lambda,
    aws_lambda_function.admin_sign_in_lambda
  ]
}

resource "aws_api_gateway_resource" "get_bookings_api_resource" {
...
resource "aws_api_gateway_method" "get_bookings_get_method" {
  rest_api_id   = aws_api_gateway_rest_api.admin_api.id
  resource_id   = aws_api_gateway_resource.get_bookings_api_resource.id
  http_method   = "GET"
  authorization = "NONE"
}

resource "aws_api_gateway_integration" "get_bookings_get_integration" {
  rest_api_id             = aws_api_gateway_rest_api.admin_api.id
  resource_id             = aws_api_gateway_resource.get_bookings_api_resource.id
  http_method             = aws_api_gateway_method.get_bookings_get_method.http_method
...
resource "aws_api_gateway_method_response" "get_bookings_method_response" {
  rest_api_id = aws_api_gateway_rest_api.admin_api.id
  resource_id = aws_api_gateway_resource.get_bookings_api_resource.id
  http_method = aws_api_gateway_method.get_bookings_get_method.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration_response" "get_bookings_get_integration_response" {
  rest_api_id = aws_api_gateway_rest_api.admin_api.id
  resource_id = aws_api_gateway_resource.get_bookings_api_resource.id
  http_method = aws_api_gateway_method.get_bookings_get_method.http_method
  status_code = aws_api_gateway_method_response.get_bookings_method_response.status_code
  ...
  depends_on = [
    aws_api_gateway_integration.get_bookings_get_integration
  ]
}

############## OPTIONS get-bookings (for cors) ##############
...
resource "aws_api_gateway_method_response" "get_bookings_options_method_response" {
  rest_api_id = aws_api_gateway_rest_api.admin_api.id
  resource_id = aws_api_gateway_resource.get_bookings_api_resource.id
  http_method = aws_api_gateway_method.get_bookings_options_method.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration_response" "get_bookings_options_integration_response" {
  rest_api_id = aws_api_gateway_rest_api.admin_api.id
  resource_id = aws_api_gateway_resource.get_bookings_api_resource.id
  http_method = aws_api_gateway_method.get_bookings_options_method.http_method
  status_code = aws_api_gateway_method_response.get_bookings_options_method_response.status_code
...
resource "aws_api_gateway_deployment" "admin_api_deployment" {
  ...
  depends_on  = [
    ...
    aws_api_gateway_integration.admin_sign_in_post_integration,
    aws_api_gateway_integration.admin_sign_in_options_integration,
    aws_api_gateway_integration_response.get_bookings_get_integration_response,
    aws_api_gateway_integration_response.get_bookings_options_integration_response,
  ...
  triggers = {
    redeployment = sha1(jsonencode([
      ...
      aws_api_gateway_resource.get_bookings_api_resource.id,
      aws_api_gateway_resource.confirm_visit_api_resource.id,
      aws_api_gateway_resource.admin_sign_in_api_resource.id,
      aws_api_gateway_method.get_bookings_get_method.id,
      aws_api_gateway_method.get_bookings_options_method.id,
      ...
      aws_api_gateway_integration.get_bookings_get_integration.id,
      aws_api_gateway_integration.get_bookings_options_integration.id,
